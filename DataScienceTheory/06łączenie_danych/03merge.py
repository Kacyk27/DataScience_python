...
#praktyka pozwalająca na powrót do początkowych danych
ten = ten_pl.copy()
plw = plw_pl.copy()
...
out = pd.merge(ten, plw, how='inner', left_index=True, right_index=True, suffixes=('_TEN','_PLW'))
...
out1 = pd.merge(ten, plw, how='outer', left_index=True, right_index=True, suffixes=('_TEN','_PLW'))

#%% bonus obliczenie dziennej zmiany na kursie
...
#%% konwersja flagi na dane liczbowe 0/1
